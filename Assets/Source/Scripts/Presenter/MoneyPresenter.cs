...
public class MoneyPresenter : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        {
            float axisX = Random.Range(Config.MinRandomMoneyPosition, Config.MaxRandomMoneyPosition);
            float axisY = Random.Range(Config.MinRandomMoneyPosition, Config.MaxRandomMoneyPosition);
            normalizedPath.Add(point.position + new Vector3(axisX, axisY));
        }
